...
user_table_create = ("""CREATE TABLE IF NOT EXISTS users(user_id int not null unique, 
                    first_name varchar, 
                    last_name varchar, 
                    gender varchar, 
                    level varchar)
...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs(song_id varchar not null unique, 
                    title varchar, 
                    artist_id varchar, 
                    year int, 
                    duration decimal)
...
artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists(artist_id varchar not null unique, 
                    name varchar, 
                    location varchar, 
                    lattitude numeric, 
                    longitude numeric)
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS time(start_time bigint not null unique, 
                    hour int, 
                    day int, 
                    week int, 
                    month int, 
